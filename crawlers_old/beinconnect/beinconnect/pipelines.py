...
class BeinconnectPipeline(object):  
    def __init__(self):  
        #Mysql Database connection.
        self.conn = MySQLdb.connect("localhost","root","N166i124Mbh","movies_scrap",charset="utf8", use_unicode=True) #N166i124Mbh movies_scrap
    ...
    def process_item(self, item, spider):
            ...
            if(item and spider.name == 'beinscrap'):
              Vendor_id = 4 
